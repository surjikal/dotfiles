...
# export PIPENV_DEFAULT_PYTHON_VERSION="3.8.16" # should match pyenv global
...
if is_installed pyenv; then
    ...
    function pyenv-pip-upgrade {
        pyenv exec sh -c '
        export PIP_IGNORE_INSTALLED=''
        export PIP_REQUIRE_VIRTUALENV=''
        PIP_REQUIRE_VIRTUALENV='' PIP_IGNORE_INSTALLED='' python -m pip install --upgrade pip
        '
    }
    function pyenv-pip {
        PIP_REQUIRE_VIRTUALENV="" pyenv exec pip "$@"
    }
